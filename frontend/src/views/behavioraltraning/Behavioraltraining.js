...
//           about_the_training:about_the_training
//         }));
...
//       body: rows.map((row) => [row.slno,  row.date, row.trainername, row.refrno,row.about_the_training]),
//     });
...
//                 />
//               </TableCell>
//               <TableCell align="right">{row.about_the_training}</TableCell>
//                   </TableRow>
//                 );
//               })}
//               {emptyRows > 0 && (
